    ...
    return(
      ...
      >
        ...
        <div>
          ...
          <div id="cubos" className="flex md:flex-nowrap lg: flex-wrap lg:space-x-8 md: space-x-1 pt-12 ">
           ...
           <div id="cubos" className="flex md:flex-nowrap lg: flex-wrap lg:space-x-8 md: space-x-1 lg:pb-20">
